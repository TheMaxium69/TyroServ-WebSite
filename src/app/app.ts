...
export class App {
  ...
  public PROJECT_CONTENT = computed(() =>
    this.langService.lang() === 'en'
      ? `<strong>TyroServ</strong> is a <strong>modded Minecraft PVP Faction server</strong> part of the Tyrolium ecosystem. Designed to offer a unique and original experience through the <strong>TyroMod</strong>, our very own mod built exclusively for our server. <em>A Tyrolium subsidiary.</em>`
