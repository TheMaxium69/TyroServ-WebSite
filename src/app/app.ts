...
export class App {
  ...
  public PROJECT_CONTENT = computed(() =>
    this.langService.lang() === 'en'
      ? `<strong>TyroServ</strong> is a <strong>modded Minecraft PVP Faction server</strong> part of the Tyrolium ecosystem. Built for competitive and community-driven gameplay, with custom mods and an immersive experience. <em>A Tyrolium project.</em>`
      : `<strong>TyroServ</strong> est un <strong>serveur Minecraft PVP Faction moddé</strong> au sein de l'écosystème Tyrolium. Conçu pour un gameplay compétitif et communautaire, avec des mods personnalisés et une expérience immersive. <em>Un projet Tyrolium.</em>`
  );
